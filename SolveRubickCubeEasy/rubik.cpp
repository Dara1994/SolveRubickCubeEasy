...
rubik::rubik(QWidget *parent) : QMainWindow(parent), ui(new Ui::rubik)
{
	ui->setupUi(this);
	...
	connect(ui->make_cube_btn, SIGNAL(clicked()), Widget,
		SLOT(make_random_cube()));
	...
	connect(ui->six_spots_btn, SIGNAL(clicked()), Widget,
		SLOT(spots_ptn()));
	connect(ui->checkerboard_btn, SIGNAL(clicked()), Widget,
		SLOT(checker_ptn()));
	connect(ui->cross_btn, SIGNAL(clicked()), Widget, SLOT(cross_ptn()));
	connect(ui->cube_in_cube_btn, SIGNAL(clicked()), Widget,
		SLOT(cube_in_cube_ptn()));
}
 ...
 *
 * U switchu prosledujemo value i u zavisnosti od nje nasumicno biramo jednu
 * cienicu za prikaz u QmessegeBox.
 */
void rubik::on_FunFacts_clicked()
{
	...
	case 2:
		QMessageBox::information(
			this, "Fun fun fun",
			"The best speed cubers* can solve the cube in under six seconds. And you are not one of them?");
		break;
	case 3:
		QMessageBox::information(
			this, "Fun fun fun",
	...
	case 4:
		QMessageBox::information(
			this, "Fun fun fun",
			"Someone took 28.80 seconds to solve the puzzle BLINDFOLDED!");
		break;
	case 5:
		QMessageBox::information(
			this, "Fun fun fun",
	...
	case 6:
		QMessageBox::information(
			this, "Fun fun fun",
			"The world’s largest Rubik’s Cube is located in Knoxville, Tennessee. It is three metres tall and weighs over 500kg.");
		break;
	case 7:
		QMessageBox::information(
			this, "Fun fun fun",
			"The smallest cube is 10mm wide and was made by Russian Evgeniy Grigoriev.");
		break;
	case 8:
		QMessageBox::information(
			this, "Fun fun fun",
			"The most expensive cube ever produced is the Masterpiece Cube, created by Diamond Cutters International in 1995.");
		break;
	case 9:
		QMessageBox::information(this, "Fun fun fun",
